...
export default function Contact() {
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center relative z-50 inset-0 overflow-y-scroll hide pt-" data-aos="fade-up-right">
                ...
                <div className="relative mt-4">
                    ...
                    <div className=' absolute z-50 top-[8%] left-[19%] flex flex-col gap-4 text-start lg:w-[500px] md:w-[400px] sm:w-[350px] max-sm:w-[250px] lg:left-[19%] md:left-[24%]'>
